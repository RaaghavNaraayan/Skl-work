...
db = mysql.connector.connect(host ="localhost",user = "root",password = 'thisismysql',database='db')
cursor = db.cursor()
 
window=Tk()
window.title("Library Management System")
 
greet = Label(window, font = ('arial', 30, 'bold'), text = "Library management system")
